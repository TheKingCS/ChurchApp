                  ...
                  {openMenuId === service.id && (
                    <>
                      ...
                      <div
                        ...
                        className="absolute right-0 top-9 z-30 w-40 rounded-xl border border-neutral-700 bg-neutral-800 shadow-lg py-1 overflow-hidden"
                      >
                        <button
                          onClick={() => {
                            setOpenMenuId(null);
                          ...
                          className="w-full text-left px-3 py-2 text-sm text-neutral-200 hover:bg-neutral-700 cursor-pointer"
                        >
                          Edit
                        </button>
                        <button
                          onClick={() => {
                            setOpenMenuId(null);
                            router.push(`/service/${service.id}/control`);
                          }}
                          className="w-full text-left px-3 py-2 text-sm text-neutral-200 hover:bg-neutral-700 cursor-pointer"
                        >
                          Remote control
                        ...
                        <button
                          ...
                          className="w-full text-left px-3 py-2 text-sm text-neutral-200 hover:bg-neutral-700 cursor-pointer disabled:opacity-50"
                        >
                          Duplicate
                        </button>
                        <button
                          ...
                          className="w-full text-left px-3 py-2 text-sm text-red-400 hover:bg-red-950/50 cursor-pointer disabled:opacity-50"
                        >
                          Delete
                        </button>
                      </div>
